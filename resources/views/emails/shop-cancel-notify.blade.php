...
<body style="margin:0;background:#111216;color:#1b1f23;font-family:Arial, sans-serif;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#111216;padding:28px 0;">
        <tr>
            <td align="center">
                <table width="660" cellpadding="0" cellspacing="0" style="background:#f4f6f7;border-radius:14px;overflow:hidden;border:1px solid #dfe6ea;">
                    <tr>
                        <td style="padding:18px 24px;background:#1a1d20;color:#f4f6f7;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td valign="middle">
                                        ...
                                        <div style="font-size:20px;font-weight:700;margin-top:4px;">Eskaria ezeztatua</div>
                                        <div style="font-size:12px;color:#c8d0d6;margin-top:2px;">Eskaria #{{ $order->id }} · {{ $order->created_at?->format('Y-m-d H:i') }}</div>
                                    </td>
                                    <td align="right" valign="middle">
                                        <span style="display:inline-block;padding:6px 12px;border-radius:999px;background:#d97b6a;color:#111216;font-size:11px;font-weight:700;letter-spacing:1px;">EZEZTATUA</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
