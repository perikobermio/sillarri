                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:#f6f1e8;border-radius:12px;overflow:hidden;">
                    <tr>
                        <td style="padding:18px 24px;background:#1e1b18;color:#f6f1e8;">
                            ...
                            <h1 style="margin:14px 0 4px;font-size:20px;">Eskaria bertan behera</h1>
                            <p style="margin:0;font-size:14px;color:#e8ddce;">Zure eskaria ezeztatu egin da.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:20px 24px;">
                            <p style="margin:0 0 10px;font-size:14px;">
                                Eskaria #{{ $order->id }} · {{ $order->created_at?->format('Y-m-d H:i') }}
                            </p>
                            ...
                            <p style="margin-top:14px;font-size:13px;color:#6c655b;">
                                Zalantzarik baduzu, jarri gurekin harremanetan.
                            </p>
                        </td>
                    </tr>
                    <tr>
