                ...
                <table width="620" cellpadding="0" cellspacing="0" style="background:#f6f1e8;border-radius:12px;overflow:hidden;">
                    <tr>
                        <td style="padding:18px 24px;background:#1e1b18;color:#f6f1e8;">
                            ...
                            <h1 style="margin:14px 0 4px;font-size:20px;">Eskari berria jaso da</h1>
                            <p style="margin:0;font-size:14px;color:#e8ddce;">Eskaria #{{ $order->id }} · {{ $order->created_at?->format('Y-m-d H:i') }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 24px;">
                            ...
                            <p style="margin-top:14px;font-size:13px;color:#6c655b;">
                                Mesedez, prestatu produktuak eta jarri bezeroarekin harremanetan.
                            </p>
                        </td>
                    </tr>
                    <tr>
